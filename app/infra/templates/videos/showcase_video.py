"""
Video Template: Showcase — Animated bold modern reveal.
"""
...
class ShowcaseVideoTemplate(BaseTemplate):
    name = "showcase_video"
    display_name = "Showcase Video"
...
<div class="ad">
    <div class="top">
        ...
        <div class="hero-label anim a2">{ctx.category or 'New Collection'}</div>
        <div class="hero-name anim a3">{ctx.product_name}</div>
    </div>
    <div class="photo-zone">
        {photo_block}
    </div>
    <div class="bottom">
        <div class="price anim price-glow" style="opacity:0;transform:translateY(20px);">{ctx.price_formatted}</div>
        <div class="cta-anim" style="opacity:0;transform:translateY(20px);">
            <a class="cta-btn" href="#">Order Now &rarr;</a>
        </div>
        <div class="footer anim a7">
