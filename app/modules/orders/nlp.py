...
async def smart_parse_customer_message(
    ...
    *,
    ...
    prompt = (
        ...
        "- action=clarify: customer wants to buy but you need more info (which model, size, variant).\n"
        "  In 'reply', list matching options as a NUMBERED LIST in this exact format:\n"
        "  1. Product Name - N123,000\n"
        "  2. Product Name - N456,000\n"
        "  ALWAYS use this numbered format (number + dot + name + dash + N + price). Max 5-8 options.\n"
        "  End with a short question like 'Which would you like?'\n"
